...
import "./AboutUs.css";
import storyLogo from "../assets/UrbanEdge_Living_Space_Logo_HD.jpg";
import offerImageOne from "../assets/ChatGPT Image Jul 6, 2026, 06_20_23 PM.png";
import offerImageTwo from "../assets/ChatGPT Image Jul 6, 2026, 06_22_09 PM.png";
import offerImageThree from "../assets/ChatGPT Image Jul 6, 2026, 06_22_43 PM.png";
import {
  Target,
  Eye,
  ShieldCheck,
...
const AboutUs = () => {
  ...
  return (
    <div className="aboutus-page">
      <SEOHead
        title="About Us"
        description="Learn about UrbanEdge Living Space — a Gandhinagar real estate consultancy built on integrity, innovation, and luxury property solutions."
        path="/about-us"
      ...
      <header
        ...
        role="banner"
        aria-label="About UrbanEdge Living"
      >
      ...
      <main>
        ...
        >
          <div className="aboutus-story-header">
            ...
            <p className="aboutus-story-lead">
              At UrbanEdge Living Space, we believe that every property
          ...
          <div className="aboutus-story-body">
            ...
            <div className="aboutus-story-content">
              <p>
                ...
                UrbanEdge Living Space was built on the principles of trust,
              ...
              <p>
                At UrbanEdge Living Space, we don't measure our success by the
        ...
        <section className="aboutus-tagline-banner" aria-label="Brand tagline">
          <p className="aboutus-tagline-brand">UrbanEdge Living Space</p>
