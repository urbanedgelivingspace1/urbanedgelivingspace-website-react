...
function buildLeadWhatsAppMessage(lead) {
  ...
  if (lead.property_name) {
    return `Hi ${name}, thanks for your interest in ${lead.property_name}. This is UrbanEdge Living Space — how can we help?`;
  }
  return `Hi ${name}, thanks for reaching out to UrbanEdge Living Space. How can we help?`;
}
